/*
   ESP Environmental Monitor Settings

   Settings and personalization of the Environmental Monitor
*/

// Network settings
String ssid = "your_ssid";
String wifi_password = "your_password";
String wifi_hostname = "EnvMonitor";

// OpenWeatherMap settings
// The API key is personal and you can get one for free at OpenWeatherMap website
